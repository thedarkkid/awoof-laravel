                        ...
                        <ul class="row">
                            ...
                            <li class="col-sm-3 animate fadeIn" data-wow-delay="0.2s">
                                <div class="items-in">
                                    ...
                                    <!-- Image -->
                                    <img src="{{asset('assets/sebian')}}/images/new-item-5.jpg" alt="">
                                    <!-- Hover Details -->
                                    <div class="over-item">
                                        <ul class="animated fadeIn">
                                            <li> <a href="images/new-item-5.jpg" data-lighter><i class="ion-search"></i></a></li>
                                            <li> <a href="#."><i class="ion-shuffle"></i></a></li>
                                            <li> <a href="#."><i class="fa fa-heart-o"></i></a></li>
                                            <li class="full-w"> <a href="#." class="btn">ADD TO CART</a></li>
                                            <!-- Rating Stars -->
                            ...
                            <li class="col-sm-3 animate fadeIn" data-wow-delay="0.4s">
                                <div class="items-in">
                                    ...
                                    <!-- Image -->
                                    <img src="{{asset('assets/sebian')}}/images/new-item-6.jpg" alt="">
                                    <!-- Hover Details -->
                                    <div class="over-item">
                                        <ul class="animated fadeIn">
                                            <li> <a href="images/new-item-6.jpg" data-lighter><i class="ion-search"></i></a></li>
                                            <li> <a href="#."><i class="ion-shuffle"></i></a></li>
                                            <li> <a href="#."><i class="fa fa-heart-o"></i></a></li>
                                            <li class="full-w"> <a href="#." class="btn">ADD TO CART</a></li>
                                            <!-- Rating Stars -->
                            ...
                            <li class="col-sm-3 animate fadeIn" data-wow-delay="0.6s">
                                <div class="items-in">
                                    <!-- Image -->
                                    <img src="{{asset('assets/sebian')}}/images/new-item-7.jpg" alt="">
                                    <!-- Hover Details -->
                                    <div class="over-item">
                                        <ul class="animated fadeIn">
                                            <li> <a href="images/new-item-7.jpg" data-lighter><i class="ion-search"></i></a></li>
                                            <li> <a href="#."><i class="ion-shuffle"></i></a></li>
                                            <li> <a href="#."><i class="fa fa-heart-o"></i></a></li>
                                            <li class="full-w"> <a href="#." class="btn">ADD TO CART</a></li>
                                            <!-- Rating Stars -->
                            ...
                            <li class="col-sm-3 animate fadeIn" data-wow-delay="0.8s">
                                <div class="items-in">
                                    <!-- Image -->
                                    <img src="{{asset('assets/sebian')}}/images/new-item-8.jpg" alt="">
                                    <!-- Hover Details -->
                                    <div class="over-item">
                                        <ul class="animated fadeIn">
                                            <li> <a href="images/new-item-8.jpg" data-lighter><i class="ion-search"></i></a></li>
                                            <li> <a href="#."><i class="ion-shuffle"></i></a></li>
                                            <li> <a href="#."><i class="fa fa-heart-o"></i></a></li>
                                            <li class="full-w"> <a href="#." class="btn">ADD TO CART</a></li>
                                            <!-- Rating Stars -->
                            ...
                            <li class="col-sm-3 animate fadeIn" data-wow-delay="0.2s">
                                <div class="items-in">
                                    ...
                                    <!-- Image -->
                                    <img src="{{asset('assets/sebian')}}/images/new-item-9.jpg" alt="">
                                    <!-- Hover Details -->
                                    <div class="over-item">
                                        <ul class="animated fadeIn">
                                            <li> <a href="images/new-item-9.jpg" data-lighter><i class="ion-search"></i></a></li>
                                            <li> <a href="#."><i class="ion-shuffle"></i></a></li>
                                            <li> <a href="#."><i class="fa fa-heart-o"></i></a></li>
                                            <li class="full-w"> <a href="#." class="btn">ADD TO CART</a></li>
                                            <!-- Rating Stars -->
                            ...
                            <li class="col-sm-3 animate fadeIn" data-wow-delay="0.4s">
                                <div class="items-in">
                                    <!-- Image -->
                                    <img src="{{asset('assets/sebian')}}/images/new-item-10.jpg" alt="">
                                    <!-- Hover Details -->
                                    <div class="over-item">
                                        <ul class="animated fadeIn">
                                            <li> <a href="images/new-item-10.jpg" data-lighter><i class="ion-search"></i></a></li>
                                            <li> <a href="#."><i class="ion-shuffle"></i></a></li>
                                            <li> <a href="#."><i class="fa fa-heart-o"></i></a></li>
                                            <li class="full-w"> <a href="#." class="btn">ADD TO CART</a></li>
                                            <!-- Rating Stars -->
                            ...
                            <li class="col-sm-3 animate fadeIn" data-wow-delay="0.6s">
                                <div class="items-in">
                                    <!-- Image -->
                                    <img src="{{asset('assets/sebian')}}/images/new-item-11.jpg" alt="">
                                    <!-- Hover Details -->
                                    <div class="over-item">
                                        <ul class="animated fadeIn">
                                            <li> <a href="images/new-item-11.jpg" data-lighter><i class="ion-search"></i></a></li>
                                            <li> <a href="#."><i class="ion-shuffle"></i></a></li>
                                            <li> <a href="#."><i class="fa fa-heart-o"></i></a></li>
                                            <li class="full-w"> <a href="#." class="btn">ADD TO CART</a></li>
                                            <!-- Rating Stars -->
                            ...
                            <li class="col-sm-3 animate fadeIn" data-wow-delay="0.8s">
                                <div class="items-in">
                                    <!-- Image -->
                                    <img src="{{asset('assets/sebian')}}/images/new-item-12.jpg" alt="">
                                    <!-- Hover Details -->
                                    <div class="over-item">
                                        <ul class="animated fadeIn">
                                            <li> <a href="images/new-item-12.jpg" data-lighter><i class="ion-search"></i></a></li>
                                            <li> <a href="#."><i class="ion-shuffle"></i></a></li>
                                            <li> <a href="#."><i class="fa fa-heart-o"></i></a></li>
                                            <li class="full-w"> <a href="#." class="btn">ADD TO CART</a></li>
                                            <!-- Rating Stars -->
