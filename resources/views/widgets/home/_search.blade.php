            ...
            <div class="col-md-6">
                <ul class="row">
                    ...
                    <li class="col-sm-6">
                        <h5>FLICKR PHOTO</h5>
                        <ul class="flicker">
                            <li><a href="#."><img src="{{ asset('assets/sebian/') }}/images/flicker-1.jpg" alt=""></a></li>
                            <li><a href="#."><img src="{{ asset('assets/sebian/') }}/images/flicker-2.jpg" alt=""></a></li>
                            <li><a href="#."><img src="{{ asset('assets/sebian/') }}/images/flicker-3.jpg" alt=""></a></li>
                            <li><a href="#."><img src="{{ asset('assets/sebian/') }}/images/flicker-4.jpg" alt=""></a></li>
                            <li><a href="#."><img src="{{ asset('assets/sebian/') }}/images/flicker-5.jpg" alt=""></a></li>
                            <li><a href="#."><img src="{{ asset('assets/sebian/') }}/images/flicker-6.jpg" alt=""></a></li>
                        </ul>
                    </li>
                </ul>
            </div>
